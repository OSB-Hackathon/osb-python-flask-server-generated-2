...
def service_instance_deprovision(X_Broker_API_Version, instance_id, service_id, plan_id, X_Broker_API_Originating_Identity=None, X_Broker_API_Request_Identity=None, accepts_incomplete=None):  # noqa: E501
...
def service_instance_get(X_Broker_API_Version, instance_id, X_Broker_API_Originating_Identity=None, X_Broker_API_Request_Identity=None, service_id=None, plan_id=None):  # noqa: E501
...
def service_instance_last_operation_get(X_Broker_API_Version, instance_id, X_Broker_API_Originating_Identity=None, X_Broker_API_Request_Identity=None, service_id=None, plan_id=None, operation=None):  # noqa: E501
...
def service_instance_provision(X_Broker_API_Version, instance_id, body, X_Broker_API_Originating_Identity=None, X_Broker_API_Request_Identity=None, accepts_incomplete=None):  # noqa: E501
...
def service_instance_update(X_Broker_API_Version, instance_id, body, X_Broker_API_Originating_Identity=None, X_Broker_API_Request_Identity=None, accepts_incomplete=None):  # noqa: E501
